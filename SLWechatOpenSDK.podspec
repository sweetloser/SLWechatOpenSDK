#
#  Be sure to run `pod spec lint SLWechatOpenSDK.podspec' to ensure this is a
...
微信SDK
  ...
  # Or just: spec.author    = "sweetloser"
  # spec.authors            = { "sweetloser" => "18272160172@163.com" }
  # spec.social_media_url   = "https://twitter.com/sweetloser"
